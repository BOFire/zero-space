...
logo: /medias/comment.jpg # 为空则不显示

# 网站 favicon
# favicon: /favicon.ico # or .png .jpg .svg .gif .jpeg .ico
favicon: /medias/comment.jpg # or .png .jpg .svg .gif .jpeg .ico
...
swiper:
  ...
  defaultTile: '林夕抚晚风' # 标题
  defaultDesc: ['煮酒洗净尘嚣，论知交', '万般付之一笑，共偕老','静水流深，沧笙踏歌','三生阴晴圆缺，一朝悲欢离合','相忘谁先忘，倾国是故国','泠泠不肯弹，蹁跹影惊鸿。'] #描 述，例如 ['煮酒洗净尘嚣，论知交', '万般付之一笑，共偕老']
...
# 支付宝打赏图片相对路径
Alipay: '/medias/about.jpg'
# 微信打赏图片相对路径
WeChatpay: '/medias/about.jpg'
...
# 首页文章列表滚动动画，详情参照https://github.com/michalsnik
aos:
  on: true
  animate: 'fade-up' # animate, 更多选项请参考 https://github.com/michalsnik/aos#animations
...
notice:
  ...
  list: # list相当于数组对象，[{title:'xx',date: 'xx', url: 'xxx', color: 'red'}]根据自己实际情况，增加或者删除
    - title: '#别急着打赏哦，稳住～'
      date: '2021-08-17'
      url: 'https://zero-space.vercel.app/archives'   # 可以为空, 也可以是本地页面地址如 '/archives'
      color: red   # 字体颜色
    - title: '#沐汐小站又来咯'
      date: '2021-08-17'
      url: 'https://zero-space.vercel.app'
      color: blue
...
site_footer:
  ...
  copyright: 'Copyright © 2019 - 2020 Zero Space By muxi '
